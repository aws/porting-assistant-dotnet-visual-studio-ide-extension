...
namespace IDE_UITest.Tests.Vs2022
{
    ...
    public class InitialSetUpWorkflowTestsVs2022 : TestBase, IDisposable
    {
        private GlobalFixture _fixture;
        private readonly ITestOutputHelper output;
        private VSMainView root;
        private Secret awsSecret;
        public InitialSetUpWorkflowTestsVs2022(GlobalFixture fixture, ITestOutputHelper output) : base(output)
        {
            VSProcessID = 0;
            this.output = output;
            _fixture = fixture;
        ...
        {
            var paExtensionDownloadUrl = _fixture.InputData["pa-extension-2022-download-url"];
            var paExtensionLocalPath = _fixture.InputData["pa-extension-2022-local-path"];
            ...
            output.WriteLine("Download Porting Assistant Extension for Visual Studio 2022");
            ...
            output.WriteLine("Install Porting Assistant Extension for Visual Studio 2022");
